...
<div class="d-flex justify-content-between">
    ...
    <a href="{{ route('admin.kelas.create') }}" class="btn btn-primary">Create Jurusan</a>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center d-flex gap-2 justify-content-center align-items-center">
                        <a href="{{ route('admin.kelas.edit', $data->id) }}" class="text-black font-weight-bold text-xs btn btn-warning" data-toggle="tooltip" data-original-title="Edit user">
                            Edit
                        </a>
                        <form action="{{ route('admin.kelas.destroy', $data->id) }}"
                            method="POST"
