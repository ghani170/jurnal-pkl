  ...
  <div class="row">
    ...
    <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        ...
        <div class="card-footer p-2 ps-3">
          <p class="mb-0 text-sm"><span class="text-danger font-weight-bolder"></span><a href="{{ route('siswa.kegiatan.index') }}">Lihat Kegiatan</a></p>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-6 col-sm-6 mt-4">
      <div class="card">
        ...
        <hr class="dark horizontal my-0">
        <div class="card-footer p-2 ps-3">
          <p class="mb-0 text-sm"><span class="text-success font-weight-bolder"></span><a href="{{ route('pembimbing.lihatsiswa.index') }}">Lihat Siswa</a></p>
        </div>
      </div>
    </div>
  </div>
