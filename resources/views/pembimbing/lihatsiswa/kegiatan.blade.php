    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 fw-semibold text-dark">Informasi Profil</h5>
            ...
            <div class="list-group list-group-flush">
                <div class="list-group-item px-0 py-3 border-bottom">
                    <div class="flex-column">
                        <span class="text-dark mb-1 fw-bold">Nama Lengkap: </span>
                        <span class="text-dark">{{ $siswa->user->name }}</span>
                    </div>
                </div>
                <div class="list-group-item px-0 py-3 border-bottom">
                    <div class="flex-column">
                        <span class="text-dark mb-1 fw-bold">Kelas: </span>
                        <span class="text-dark">{{ $siswa->kelas->kelas }} {{ $siswa->jurusan->jurusan }}</span>
                    </div>
                </div>
                <div class="list-group-item px-0 py-3 border-bottom">
                    <div class="flex-column">
                        <span class="text-dark mb-1 fw-bold">Dudi: </span>
                        <span class="text-dark">{{ $siswa->dudi->nama_dudi }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped align-items-center mb-0">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Nama
                            Siswa</th>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Tanggal
                        </th>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Jam
                            Mulai</th>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Jam
                            Selesai</th>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Kegiatan
                        </th>
                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Catatan
                        </th>
                    ...
                    @foreach ($kegiatans as $data)
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    {{ $data->mulai_kegiatan ? \Carbon\Carbon::parse($data->mulai_kegiatan)->format('H:i') : '-' }}
                                </td>
                                <td class="align-middle text-center text-sm">
                                    {{ $data->akhir_kegiatan ? \Carbon\Carbon::parse($data->akhir_kegiatan)->format('H:i') : '-' }}
                                </td>
                                <td class="align-middle text-center text-sm">
